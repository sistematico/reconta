...
<template>
  <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <!-- <img class="mx-auto h-10 w-auto" src="/images/logo.svg" :alt="appName" /> -->
      <h2 class="mt-10 text-center text-3xl font-bold leading-9 tracking-tight">Entrar</h2>
    </div>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        ...
        <a href="#" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Crie uma conta</a>, é simples e rápido.
      </p>
    </div>
  </div>
</template>